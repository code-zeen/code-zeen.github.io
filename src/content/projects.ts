    ...
    description:
      {
        text: {
          ...
          en: 'I was responsible for brainstorming and creating a <em>text-based editor</em> that allows teachers to <em>create their own content</em> to be saved into the questions database.<br/><br/>' +
          ...
          de: 'Ich übernahm die Verantwortung, einen <em>textbasierten Editor</em> zu entwickeln und zu erstellen, mit dem Lehrkräfte <em>eigene Inhalte erstellen</em> und in der Fragendatenbank speichern können.<br/><br/>' +
